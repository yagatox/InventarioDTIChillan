...
public class Articulo_de_Reserva_pantalla_normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_articulo_de__reserva_pantalla_normal);
        Button boton_reserva = findViewById(R.id.boton_reserva);


        //dato pasado de la pantalla reserva
        dato=getIntent().getExtras().getInt("id_articulo");
