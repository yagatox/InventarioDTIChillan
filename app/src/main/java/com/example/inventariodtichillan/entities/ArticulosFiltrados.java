...
public class ArticulosFiltrados {
    ...
    public ArticulosFiltrados(int id, String nombre, String valor, String cantidad, String caracteristicas, String estado, String color, String fecha_compra, int numero_orden_compra, String marca, int stock_actual, int stock_minimo, String modelo, String proveedor, String qr_code, int ultimo_precio_compra, String estado_reserva, int numero_de_serie, String fecha_creacion_QR, int tipo, int seccion) {
        this.id = id;
        this.nombre = nombre;
        this.valor = valor;
